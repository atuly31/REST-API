...
app.get("/rando",(req,res)=>{
    ...
    let val = Math.floor(Math.random() *jokes.length);
    res.json(jokes[val]);
...
app.post("/jokes",(req,res)=>{
  const id_u = parseInt(req.body.id);
  const joke_u = req.body.jokeText;
  const jokeType_u = req.body.jokeType;
  const newjoke = {
      id:id_u,
      jokeText:joke_u,
      jokeType :jokeType_u,
...
app.patch("/jokes/:id",(req,res) =>{
   ...
   const search_idx = jokes.findIndex((joke)=> joke.id===id);
   jokes[search_idx] = replacementJoke;
